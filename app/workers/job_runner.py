...
from app.workers.docker_utils import start_container
...
async def job_runner(
    ...
    """Task to run the generated code in a Docker container."""
    ...
    try:
        ...
        logger.info(
            f"[{job_id}] Docker container {container_id} started. Enqueuing polling task."
        )
